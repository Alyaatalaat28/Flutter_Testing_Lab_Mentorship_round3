...
class _ShoppingCartState extends State<ShoppingCart> {
  ...
  void _addItem(String id, String name, double price, {double discount = 0.0}) {
    setState(() {
      cartManager.addItem(id, name, price, discount: discount);
    });
  }
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text('Total Items: ${cartManager.totalItems}'),
                    ElevatedButton(
                ...
                Text('Subtotal: \$${cartManager.subtotal.toStringAsFixed(2)}'),
                Text('Total Discount: \$${cartManager.totalDiscount.toStringAsFixed(2)}'),
                const Divider(),
                Text(
